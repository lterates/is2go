      ...
      <v-card width="100%">
        ...
        <v-row>
          ...
          <v-col style="max-width: 25%; min-width: 25%; font-family:lato;">
            <div
              style="background-color: #F9FAFB; height:3530px; margin-bottom: 0px"
            >
              <br />
              <br />
              <v-card-text
              ...
              <v-treeview
                ...
                style="min-width: 25% font-weight: 300; font-size: 13px; margin-left: 43%"
                class="text-left"
                rounded
                selectable
            ...
            <v-layout row wrap class="ma-6">
              ...
              >
                <v-card class="mx-auto ma-6" min-width="350" max-width="350">
                  ...
                  <v-row
                    style="font-family:lato; font-weight: 500; font-size: 12px; color: hsla(0, 0%, 0%, 0.4)"
                    class="mx-0"
                  >
                    <v-rating
                  ...
                  <v-card-text
                    style="font-family:lato; margin-top; min-height: 130px"
                  >
                    <div
                      style="font-weight: 300; text-align: left; margin-left: 4%; margin-bottom: 8%"
                    >
                      {{ restaurant.tags }}
                    </div>
